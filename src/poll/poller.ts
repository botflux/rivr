...
export class Poller<State, WorkerMetadata extends DefaultWorkerMetadata> extends EventEmitter<{ error: [ unknown ], stopped: [] }> implements WorkerInterface {
  ...
  constructor(
    ...
    private readonly getStorage: () => Promise<[StorageInterface<State, WorkerMetadata>, Omit<WorkerMetadata, "workerId">]>,
  ...
  private handleSingleStep(step: SingleStep<State, WorkerMetadata>, records: PollerRecord<State>[], workerMetadata: Omit<WorkerMetadata, "workerId">): Promise<[PollerRecord<State>, StepResult<State>][]> {
  ...
  private async handleBatchStep(step: BatchStep<State, WorkerMetadata>, records: PollerRecord<State>[], workerMetadata: Omit<WorkerMetadata, "workerId">): Promise<[PollerRecord<State>, StepResult<State>][]> {
    try {
